...
set(RTEMS_SYS_SPECS_FLAGS    "-B${RTEMS_BSP_PREFIX}/${RTEMS_BSP}/lib -specs bsp_specs -qrtems")
...
#    "<CMAKE_C_COMPILER> ${RTEMS_SYS_SPECS_FLAGS} ${RTEMS_BSP_C_FLAGS} <FLAGS> ${RTEMS_SYS_LINKFLAGS} -o <TARGET>.prelink.o <OBJECTS> <CMAKE_C_LINK_FLAGS> <LINK_FLAGS> <LINK_LIBRARIES>"
#    "${RTEMS_TOOLS_PREFIX}/bin/rtems-syms -v -e -c ${RTEMS_BSP_C_FLAGS} -C <CMAKE_C_COMPILER> -o <TARGET>.dl-sym.o <TARGET>.prelink.o"
...
#)
set(CMAKE_C_LINK_EXECUTABLE
    "<CMAKE_C_COMPILER> ${RTEMS_SYS_SPECS_FLAGS} ${RTEMS_BSP_C_FLAGS} <FLAGS> ${RTEMS_SYS_LINKFLAGS} -o <TARGET> <OBJECTS> <CMAKE_C_LINK_FLAGS> <LINK_FLAGS> <LINK_LIBRARIES>"
)
set(CMAKE_CXX_LINK_EXECUTABLE
    "<CMAKE_CXX_COMPILER> ${RTEMS_SYS_SPECS_FLAGS} ${RTEMS_BSP_CXX_FLAGS} <FLAGS> ${RTEMS_SYS_LINKFLAGS} -o <TARGET> <OBJECTS> <CMAKE_CXX_LINK_FLAGS> <LINK_FLAGS> <LINK_LIBRARIES>"
)
...
set(CMAKE_PLATFORM_IMPLICIT_LINK_DIRECTORIES "${RTEMS_BSP_PREFIX}/${RTEMS_BSP}/lib")
