...
{
    BSL_SecParam_SetTextstr(&context->opt_test_key, BSLX_BIB_OPT_KEY_ID, key_id);
    BSL_SecParam_SetUint64(&context->opt_scope_flags, BSLX_BIB_OPT_SCOPE, 0);
    BSL_SecParam_SetUint64(&context->opt_sha_variant, BSLX_BIB_OPT_SHA_VARIANT, RFC9173_BIB_SHA_HMAC512);
    BSL_SecParam_SetUint64(&context->opt_use_key_wrap, BSLX_BIB_OPT_USE_KEY_WRAP, 0);
...
{
    BSL_SecParam_SetUint64(&context->opt_scope_flags, BSLX_BCB_OPT_SCOPE, 0);
    BSL_SecParam_SetTextstr(&context->opt_test_key_id, BSLX_BCB_OPT_KEY_ID, RFC9173_EXAMPLE_A2_KEY);
    BSL_SecParam_SetUint64(&context->opt_aes_variant, BSLX_BCB_OPT_AES_VARIANT, RFC9173_BCB_AES_VARIANT_A128GCM);
    BSL_SecParam_SetUint64(&context->opt_use_key_wrap, BSLX_BCB_OPT_USE_KEY_WRAP, 1);
...
RFC9173_A1_Params BSL_TestUtils_GetRFC9173_A1Params(const char *key_id)
{
    ...
    BSL_SecParam_SetUint64(&params.use_key_wrap, BSLX_BIB_OPT_USE_KEY_WRAP, 0);
    return params;
}
