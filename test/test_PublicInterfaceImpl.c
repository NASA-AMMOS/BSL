...
void setUp(void)
{
    ...
    BSL_Variant_SetTextstr(BSLP_PolicyRule_AddOption(&rule_1, BSLX_BIB_OPT_KEY_ID), RFC9173_EXAMPLE_A1_KEY);
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_1, BSLX_BIB_OPT_USE_KEY_WRAP), 0);
    ...
    BSLP_PolicyRule_InitFrom(&rule_2, 2, "ACCEPT BIB OVER PAYLOAD AT CLIN FILTER(SRC=ipn:1.2)", 1, BSL_SECROLE_ACCEPTOR,
                             BSL_SECBLOCKTYPE_BIB, BSL_BLOCK_TYPE_PAYLOAD, BSL_POLICYACTION_DROP_BUNDLE);
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_2, BSLX_BIB_OPT_SHA_VARIANT), RFC9173_BIB_SHA_HMAC512);
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_2, BSLX_BIB_OPT_SCOPE), 0);
    BSL_Variant_SetTextstr(BSLP_PolicyRule_AddOption(&rule_2, BSLX_BIB_OPT_KEY_ID), RFC9173_EXAMPLE_A2_KEY);
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_2, BSLX_BIB_OPT_USE_KEY_WRAP), 0);
    ...
    BSLP_PolicyRule_InitFrom(&rule_3, 3, "ACCEPT BIB OVER PAYLOAD AT CLIN FILTER(SRC=ipn:1.3)", 1, BSL_SECROLE_ACCEPTOR,
                             BSL_SECBLOCKTYPE_BIB, BSL_BLOCK_TYPE_PAYLOAD, BSL_POLICYACTION_DROP_BLOCK);
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_3, BSLX_BIB_OPT_SHA_VARIANT), RFC9173_BIB_SHA_HMAC512);
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_3, BSLX_BIB_OPT_SCOPE), 0);
    BSL_Variant_SetTextstr(BSLP_PolicyRule_AddOption(&rule_3, BSLX_BIB_OPT_KEY_ID), RFC9173_EXAMPLE_A2_KEY);
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_3, BSLX_BIB_OPT_USE_KEY_WRAP), 0);
    ...
    BSLP_PolicyRule_InitFrom(&rule_4, 4, "ACCEPT BIB OVER PAYLOAD AT CLIN FILTER(SRC=ipn:1.4)", 1, BSL_SECROLE_ACCEPTOR,
                             BSL_SECBLOCKTYPE_BIB, BSL_BLOCK_TYPE_PAYLOAD, BSL_POLICYACTION_NOTHING);
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_4, BSLX_BIB_OPT_SHA_VARIANT), RFC9173_BIB_SHA_HMAC512);
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_4, BSLX_BIB_OPT_SCOPE), 0);
    BSL_Variant_SetTextstr(BSLP_PolicyRule_AddOption(&rule_4, BSLX_BIB_OPT_KEY_ID), RFC9173_EXAMPLE_A2_KEY);
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_4, BSLX_BIB_OPT_USE_KEY_WRAP), 0);
    ...
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_5, BSLX_BCB_OPT_AES_VARIANT), RFC9173_BCB_AES_VARIANT_A128GCM);
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_5, BSLX_BCB_OPT_USE_KEY_WRAP), 1);
    ...
    BSLP_PolicyRule_InitFrom(&rule_6, 6, "ACCEPT BCB OVER PAYLOAD AT CLIN FILTER(SRC=ipn:1.6)", 2, BSL_SECROLE_ACCEPTOR,
                             BSL_SECBLOCKTYPE_BCB, BSL_BLOCK_TYPE_PAYLOAD, BSL_POLICYACTION_DROP_BUNDLE);
    BSL_Variant_SetTextstr(BSLP_PolicyRule_AddOption(&rule_6, BSLX_BCB_OPT_KEY_ID), RFC9173_EXAMPLE_A1_KEY);
    BSL_Variant_SetBytestr(BSLP_PolicyRule_AddOption(&rule_6, BSLX_BCB_OPT_WRAPPED_KEY), wrapkey_data);
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_6, BSLX_BCB_OPT_AES_VARIANT), RFC9173_BCB_AES_VARIANT_A128GCM);
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_6, BSLX_BCB_OPT_USE_KEY_WRAP), 1);
    ...
    BSLP_PolicyRule_InitFrom(&rule_7, 7, "ACCEPT BCB OVER PAYLOAD AT CLIN FILTER(SRC=ipn:1.7)", 2, BSL_SECROLE_ACCEPTOR,
                             BSL_SECBLOCKTYPE_BCB, BSL_BLOCK_TYPE_PAYLOAD, BSL_POLICYACTION_DROP_BLOCK);
    BSL_Variant_SetTextstr(BSLP_PolicyRule_AddOption(&rule_7, BSLX_BCB_OPT_KEY_ID), RFC9173_EXAMPLE_A1_KEY);
    BSL_Variant_SetBytestr(BSLP_PolicyRule_AddOption(&rule_7, BSLX_BCB_OPT_WRAPPED_KEY), wrapkey_data);
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_7, BSLX_BCB_OPT_AES_VARIANT), RFC9173_BCB_AES_VARIANT_A128GCM);
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_7, BSLX_BCB_OPT_USE_KEY_WRAP), 1);
    ...
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_8, BSLX_BCB_OPT_AES_VARIANT), RFC9173_BCB_AES_VARIANT_A128GCM);
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_8, BSLX_BCB_OPT_USE_KEY_WRAP), 1);
    ...
    BSL_Variant_SetTextstr(BSLP_PolicyRule_AddOption(&rule_9a, BSLX_BIB_OPT_KEY_ID), RFC9173_EXAMPLE_A1_KEY);
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_9a, BSLX_BIB_OPT_USE_KEY_WRAP), 0);
    ...
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_9b, BSLX_BCB_OPT_USE_KEY_WRAP), 1);
    ...
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_13, BSLX_BIB_OPT_USE_KEY_WRAP), 0);
    ...
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_15a, BSLX_BIB_OPT_USE_KEY_WRAP), 0);
    ...
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_17, BSLX_BIB_OPT_USE_KEY_WRAP), 0);
    ...
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_18, BSLX_BIB_OPT_USE_KEY_WRAP), 0);
    ...
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_19, BSLX_BIB_OPT_USE_KEY_WRAP), 0);
    ...
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_20, BSLX_BIB_OPT_USE_KEY_WRAP), 0);
    ...
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_21, BSLX_BCB_OPT_AES_VARIANT),
                         RFC9173_BCB_AES_VARIANT_A128GCM);
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_21, BSLX_BCB_OPT_USE_KEY_WRAP), 1);
    ...
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_22, BSLX_BCB_OPT_AES_VARIANT),
                         RFC9173_BCB_AES_VARIANT_A128GCM);
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_22, BSLX_BCB_OPT_USE_KEY_WRAP), 1);
    ...
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_23, BSLX_BCB_OPT_AES_VARIANT),
                         RFC9173_BCB_AES_VARIANT_A128GCM);
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_23, BSLX_BCB_OPT_USE_KEY_WRAP), 1);
    ...
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_24, BSLX_BCB_OPT_AES_VARIANT),
                         RFC9173_BCB_AES_VARIANT_A128GCM);
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_24, BSLX_BCB_OPT_USE_KEY_WRAP), 1);
    ...
    BSLP_PolicyRule_InitFrom(&rule_25a, 25, "VERIFY BIB OVER PAYLOAD AT APPIN FILTER(DEST=ipn:1.9)", 1,
                             BSL_SECROLE_VERIFIER, BSL_SECBLOCKTYPE_BIB, BSL_BLOCK_TYPE_PAYLOAD,
                             BSL_POLICYACTION_DROP_BLOCK);
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_25a, BSLX_BIB_OPT_SHA_VARIANT), RFC9173_BIB_SHA_HMAC512);
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_25a, BSLX_BIB_OPT_SCOPE), 0);
    BSL_Variant_SetTextstr(BSLP_PolicyRule_AddOption(&rule_25a, BSLX_BIB_OPT_KEY_ID), RFC9173_EXAMPLE_A1_KEY);
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_25a, BSLX_BIB_OPT_USE_KEY_WRAP), 0);
    ...
    BSLP_PolicyRule_InitFrom(&rule_25b, 125, "VERIFY BCB OVER PAYLOAD AT APPIN FILTER(DEST=ipn:1.9)", 2,
                             BSL_SECROLE_VERIFIER, BSL_SECBLOCKTYPE_BCB, BSL_BLOCK_TYPE_PAYLOAD,
                             BSL_POLICYACTION_DROP_BLOCK);
    BSL_Variant_SetTextstr(BSLP_PolicyRule_AddOption(&rule_25b, BSLX_BCB_OPT_KEY_ID), RFC9173_EXAMPLE_A2_KEY);
    BSL_Variant_SetBytestr(BSLP_PolicyRule_AddOption(&rule_25b, BSLX_BCB_OPT_WRAPPED_KEY), wrapkey_data);
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_25b, BSLX_BCB_OPT_AES_VARIANT),
                         RFC9173_BCB_AES_VARIANT_A128GCM);
    ...
    BSLP_PolicyRule_InitFrom(
        &rule_bsl_6, 6, "SOURCE BIB OVER PAYLOAD AT CLOUT FILTER(DEST=ipn:0.6) WITH POLICY DROP BLOCK", 1,
        BSL_SECROLE_SOURCE, BSL_SECBLOCKTYPE_BIB, BSL_BLOCK_TYPE_PAYLOAD, BSL_POLICYACTION_DROP_BLOCK);
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_bsl_6, BSLX_BIB_OPT_SHA_VARIANT), RFC9173_BIB_SHA_HMAC512);
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_bsl_6, BSLX_BIB_OPT_SCOPE), 0);
    BSL_Variant_SetTextstr(BSLP_PolicyRule_AddOption(&rule_bsl_6, BSLX_BIB_OPT_KEY_ID), RFC9173_EXAMPLE_A1_KEY);
    BSL_Variant_SetInt64(BSLP_PolicyRule_AddOption(&rule_bsl_6, BSLX_BIB_OPT_USE_KEY_WRAP), 0);
    ...
    BSLP_PolicyRule_InitFrom(&rule_bsl_32a, 32, "SOURCE BCB OVER PAYLOAD AT CLOUT FILTER(DEST=ipn:3.2)", 2,
                             BSL_SECROLE_SOURCE, BSL_SECBLOCKTYPE_BCB, BSL_BLOCK_TYPE_PAYLOAD,
                             BSL_POLICYACTION_DROP_BLOCK);
    ...
    switch (sec_role)
    {
        ...
        case BSL_SECROLE_VERIFIER:
        {
            ...
            if (good_key)
            {
                ...
                if ((sec_block_type == BSL_SECBLOCKTYPE_BCB) || (sec_block_type == TEST_BOTH_BIB_BCB))
                {
