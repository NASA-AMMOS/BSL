...
// BSL_POLICYACTION_NOTHING, false, 2, 2)
...
TEST_CASE(BSL_POLICYLOCATION_CLOUT, NULL, "ipn:1.9", NULL, BSL_SECROLE_SOURCE, 99, BSL_BLOCK_TYPE_PAYLOAD,
          BSL_POLICYACTION_DROP_BLOCK, true, 2, 2)
