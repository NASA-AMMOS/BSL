...
TEST_CASE("")
TEST_CASE("1")
TEST_CASE("0123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789") // 100 char
TEST_CASE("01234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890") // 101 char
void test_SamplePolicyProvider_PolicyRuleInit_Description(const char *description)
{
    ...
    BSLP_PolicyRule_t rule;
    BSLP_PolicyRule_Init(&rule, description, &predicate, 1, BSL_SECROLE_VERIFIER,
                         BSL_SECBLOCKTYPE_BIB, BSL_BLOCK_TYPE_PAYLOAD, BSL_POLICYACTION_DROP_BUNDLE);
