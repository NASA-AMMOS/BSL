...
void test_RFC9173_AppendixA_Example3_Acceptor(void)
{
    ...
    BSL_IdValPair_SetUint64(&bib_context.opt_use_key_wrap, BSLX_BIB_OPT_USE_KEY_WRAP, 0);
    ...
    BSL_IdValPair_SetUint64(&bcb_context.opt_use_key_wrap, BSLX_BCB_OPT_USE_KEY_WRAP, 0);
...
void test_RFC9173_AppendixA_Example3_Source(void)
{
    ...
    BSL_IdValPair_SetTextstr(&bib_context.opt_test_key, BSLX_BIB_OPT_KEY_ID, RFC9173_EXAMPLE_A1_KEY);
    BSL_IdValPair_SetUint64(&bib_context.opt_sha_variant, BSLX_BIB_OPT_SHA_VARIANT, RFC9173_BIB_SHA_HMAC256);
    BSL_IdValPair_SetUint64(&bib_context.opt_scope_flags, BSLX_BIB_OPT_SCOPE, 0);
    BSL_IdValPair_SetUint64(&bib_context.opt_use_key_wrap, BSLX_BIB_OPT_USE_KEY_WRAP, 0);
    ...
    BSL_IdValPair_SetTextstr(&bcb_context.opt_test_key_id, BSLX_BCB_OPT_KEY_ID, RFC9173_EXAMPLE_A3_KEY);
    BSL_IdValPair_SetUint64(&bcb_context.opt_scope_flags, BSLX_BCB_OPT_SCOPE, 0);
    BSL_IdValPair_SetUint64(&bcb_context.opt_aes_variant, BSLX_BCB_OPT_AES_VARIANT, 1);
    BSL_IdValPair_SetUint64(&bcb_context.opt_use_key_wrap, BSLX_BCB_OPT_USE_KEY_WRAP, 0);
...
void test_RFC9173_AppendixA_Example4_Acceptor(void)
{
    ...
    BSL_IdValPair_SetUint64(&bcb_context.opt_scope_flags, BSLX_BCB_OPT_SCOPE, 0x07);
    BSL_IdValPair_SetUint64(&bcb_context.opt_aes_variant, BSLX_BCB_OPT_AES_VARIANT, RFC9173_BCB_AES_VARIANT_A256GCM);
    BSL_IdValPair_SetUint64(&bcb_context.opt_use_key_wrap, BSLX_BCB_OPT_USE_KEY_WRAP, 0);
    ...
    BSL_IdValPair_SetTextstr(&bib_context.opt_test_key, BSLX_BIB_OPT_KEY_ID, RFC9173_EXAMPLE_A1_KEY);
    BSL_IdValPair_SetUint64(&bib_context.opt_sha_variant, BSLX_BIB_OPT_SHA_VARIANT, RFC9173_BIB_SHA_HMAC384);
    BSL_IdValPair_SetUint64(&bib_context.opt_scope_flags, BSLX_BIB_OPT_SCOPE, 0x07);
    BSL_IdValPair_SetUint64(&bib_context.opt_use_key_wrap, BSLX_BIB_OPT_USE_KEY_WRAP, 0);
